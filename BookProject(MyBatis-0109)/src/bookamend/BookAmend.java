...
import BookController.BookAmendController;
...
public class BookAmend {
	...
	public BorderPane getLayout() {
		...
		amendbtn = new Button("도서 수정");
		amendbtn.setPrefSize(150, 50);
		amendbtn.setOnAction(e -> {

			BookAmendController controller = new BookAmendController();
			...
			int count = controller.getResult(btitle, bdate, bpage, bprice, bauthor, btranslator, bsupplement,
					bpublisher, bisbn);
			System.out.println(count);
			if (count == 1) {
				Dialog<String> dialog = new Dialog<String>();
				dialog.setTitle("도서정보 수정완료");
				ButtonType type = new ButtonType("확인", ButtonData.OK_DONE);
				String st = "도서정보 수정을 완료했습니다.";
		...
		bottomflowPane.getChildren().add(amendbtn);
